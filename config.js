...
const SITE_CONFIG = {
  ...
  /* ---------------------------------------------------------------------
     ...
     WHEN YOU HAVE A VIDEO FILE:
       1. Drop the file in the assets/videos/ folder, e.g. assets/videos/hero-reel.mp4
       2. Change this block to:
            heroMedia: {
              type: "video",
              src: "assets/videos/hero-reel.mp4",
              poster: "assets/images/hero-poster.jpg" // optional preview image
            }
  ...
  /* ---------------------------------------------------------------------
     ...
     Leave as "placeholder" for the initials avatar, or switch to:
       aboutMedia: { type: "image", src: "assets/images/anish.jpg" }
     --------------------------------------------------------------------- */
  aboutMedia: {
    type: "placeholder",
    initials: "AB"
  ...
  /* ---------------------------------------------------------------------
     ...
     Each project supports its own media slot — same rules as heroMedia:
       ...
       media: { type: "video", src: "assets/videos/project-1.mp4", poster: "..." }
       media: { type: "youtube", id: "..." }
       media: { type: "image", src: "assets/images/project-1.jpg" }
